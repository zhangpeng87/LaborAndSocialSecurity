...
{
    public sealed class HttpUtilityEx
    {
        /// <summary>
        /// Url编码，与Java一致。使用UTF8
        /// </summary>
        /// <param name="str"></param>
        /// <returns></returns>
        public static string UrlEncode4Java(string str)
        {
            return UrlEncode4Java(str, Encoding.UTF8);
        }
        ...
        /// <returns></returns>
        public static string UrlEncode4Java(string str, Encoding encoding)
        {
        ...
        private static char IntToHex(int n)   //n为0-f 
        {
            if (n <= 9)
            {
